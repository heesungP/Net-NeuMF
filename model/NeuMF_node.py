...
class NeuMF:
    ...
    def __init__(self, user_num, item_num, emb_size, emb_arr):
        ...
        gmf_item_embedding = Embedding(item_num, emb_size, weights=[emb_arr], input_length=item.shape[1])(item)
        ...
        mlp_item_embedding = Embedding(item_num, emb_size, weights=[emb_arr], input_length=item.shape[1])(item)
