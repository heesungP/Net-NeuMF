...
class NeuMF:
    ...
    def __init__(self, user_num, item_num, emb_size, emb_arr, train_tf=True):
        ...
        gmf_item_embedding = Embedding(item_num, emb_size, weights=[emb_arr], input_length=item.shape[1], trainable=train_tf)(item)
        ...
        # 여기에 user, item 8짜리 embedding 더해서 32로 만들고 아래 layer 태우는거 (별로인듯)
